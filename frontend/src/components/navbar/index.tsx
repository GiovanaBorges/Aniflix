    ...
    return(
        ...
        <div className="container flex flex-wrap justify-start items-center mx-auto">
            <a href="/" className="flex items-center">
                <span className="self-center text-red-600 text-4xl font-bold whitespace-nowrap ">Nflix</span>
            </a>
            ...
            <ul className="flex flex-col p-4 mt-4 mx-5 bg-gray-50 rounded-lg border border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                <li>
